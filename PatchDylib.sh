...
"$INT" \
  ...
  -change /usr/local/lib/emptystorekit.dylib /System/Library/Frameworks/StoreKit.framework/StoreKit \
  "$DYLIB"

echo "Patched $DYLIB -> reexports /usr/lib/libSystem.B.dylib + Foundation + AVFoundation + UIKit + CFNetwork + StoreKit"
